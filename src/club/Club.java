...
public class Club
{
    ...
    /**
     * Extension 1: Calcula el total de consumos de un socio.
     * Retorna el valor total de todas las facturas pendientes de un socio
     * @return Total de consumos del socio. Retorna 0 si el socio no tiene
     */
    public double calcularTotalConsumosSocio(String cedula) {
    ...
    /**
     * Extension 2: Determina si un socio puede ser eliminado del club.
    ...
    public boolean sePuedeEliminarSocio(String cedula) {
        ...
        if(socio == null){
            System.out.println("No existe un socio con ese numero de cedula: " + cedula);
            return false;
        }
        ...
        if(!socio.darFacturas().isEmpty()){
            System.out.println("No se puede eliminar un socio con facturas a pagar");
            return false;
        }

        if(socio.darAutorizados().size() > 1){
            System.out.println("No se puede eliminar un socio con mas de 1 autorizado");
            return false;
        }
        return true;
    }
